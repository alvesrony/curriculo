...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="projetos/load/css/carregar.css">
    ...
    <script type="text/javascript" src="projetos/load/js/carregar.js"></script>
  ...
  <body>
    ...
    <div id="loadingContainer" style="display: none;">
      ...
      <div class="container_mod"  id="conteudo-carregado" style="display: none;"><!-- container_mod -->
        <div class="menu-wrap">
            <nav class="menu-top">
        ...
        <div class="content-wrap"><!-- content-wrap -->
          <div class="content"><!-- content -->
              ...
              <div class="container-usuario">
                <section id="sobre" class="area_usuario"><!-- seção usuário -->

                  <div class="container-md container-fluid"><!-- container -->
                      <div class="row d-flex mt-lg-4 div-usuario"><!-- row -->
                        <div class="col-sm-12 col-md-6 col-lg-6 text-center animate__animated animate__fadeInUp bloco-total">
                ...
                <svg style="position: relative; z-index: 0;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#101010" fill-opacity="1" d="M0,96L60,128C120,160,240,224,360,250.7C480,277,600,267,720,240C840,213,960,171,1080,165.3C1200,160,1320,192,1380,208L1440,224L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path></svg>
              </div>
