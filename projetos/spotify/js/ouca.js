$(document).ready(function() {
  ...
  function atualizarConteudoMusica() {
      ...
      // Definindo informações da música com base na URL da música atual
      let imagem;
      let nomeArtista;
      let nomeMusica;
      ...
      // Atualizando o conteúdo da div com as informações da música atual
      conteudoMusica.html(`
  ...
  //função para atualizar o conteúdo da música inicialmente
  atualizarConteudoMusica();
  
  
  /*********************  ROLAR CONTEÚDO ************************/
  function setupScrolling(containerClass) {
    ...
    var scrollForwardButton = $(containerClass + " #scrollForward");
    var scrollBackwardButton = $(containerClass + " #scrollBackward");
  ...
  // Chame a função para cada div com classe diferente
  setupScrolling(".container-produzido1");
  setupScrolling(".container-produzido2");
